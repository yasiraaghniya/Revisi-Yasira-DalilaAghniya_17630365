                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="pull-right">
                            <a href="{{ url('progams')}}" class="btn btn-secondary btn-sm">
                            ...
                            <div class="col-md-4 offset-md-4">
                                <form action="{{ url('programs') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        is-invalid @enderror" value="{{ old('student_price') }}">
                                        @error('student_price')
                                        <div class="invalid-feedback"> {{ $message }} </div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        is-invalid @enderror" value="{{ old('student_max') }}">
                                        @error('student_max')
                                        <div class="invalid-feedback"> {{ $message }} </div>
                                        @enderror
                                    </div>
